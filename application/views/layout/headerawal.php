        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href="<?= base_url('Auth/login'); ?>" class="nav-item nav-link">AquaHub</a>
                    <a href="<?= base_url('Contact/'); ?>" class="nav-item nav-link">ComplaintCenter</a>
                    <a href="<?= base_url('Auth/login'); ?>" class="nav-item nav-link<?= ($this->uri->segment(1) == 'profile') ? 'active' : ''; ?>">Profile</a>
                </div>
